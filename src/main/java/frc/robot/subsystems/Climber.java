...
public class Climber extends SubsystemBase {
    ...
    public final DoubleSolenoid climbLeft = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, 6,2);
    // Right Climber solenoid (channel 7 forward, channel 3 reverse)
    public final DoubleSolenoid climbRight = new DoubleSolenoid(PneumaticsModuleType.CTREPCM, 7, 3);
